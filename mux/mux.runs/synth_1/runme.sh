...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/mux/mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4to1_pkg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4to1_pkg.tcl
