...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/BCDto7sd/BCDto7sd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDto7sd_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCDto7sd_case.tcl
