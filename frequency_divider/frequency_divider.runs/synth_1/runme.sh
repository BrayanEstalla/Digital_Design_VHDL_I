...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/frequency_divider/frequency_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency_divider_iee.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frequency_divider_iee.tcl
