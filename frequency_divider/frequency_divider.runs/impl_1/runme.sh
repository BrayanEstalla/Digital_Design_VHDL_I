...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/frequency_divider/frequency_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency_divider_iee.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source frequency_divider_iee.tcl -notrace
