...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/register/register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_pipo_iee.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_pipo_iee.tcl -notrace
