...
HD_PWD='C:/Users/usuario/Desktop/CURSO_FPGA/register/register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_pipo_iee.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_pipo_iee.tcl
